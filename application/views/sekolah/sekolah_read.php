    ...
    <h2 style="margin-top:0px">Alat dan Bahan Read</h2>
    <table class="table">
	    <tr><td width="150px">Nama Alat dan Bahan</td><td><?php echo $nama_sekolah; ?></td></tr>
	    <tr><td>Nama Kepsek</td><td><?php echo $nama_kepsek; ?></td></tr>
	    <tr><td>Alamat Alat dan Bahan</td><td><?php echo $alamat_sekolah; ?></td></tr>
