<h2 style="margin-top:0px">DATA POLI GIGI</h2>
...
<table class="table table-bordered" style="margin-bottom: 10px">
    ...
    <?php foreach ($sekolah_data as $sekolah) { ?>
    <tr>
        <td width="80px"><?php echo ++$start ?></td>
        <td><?php echo $sekolah->nama_sekolah ?></td>
        <td><?php echo $sekolah->kondisi ?></td>
        <td><?php echo $sekolah->jumlah ?></td>
        <td style="text-align:center" width="200px">
            <?php 
            // echo anchor(site_url('sekolah/read/'.$sekolah->id_sekolah),'Read', array('class'=>'btn btn-primary btn-sm')); 
            echo ' | '; 
            echo anchor(site_url('sekolah/update/'.$sekolah->id_sekolah),'Edit', array('class'=>'btn btn-default btn-sm')); 
            echo ' | '; 
